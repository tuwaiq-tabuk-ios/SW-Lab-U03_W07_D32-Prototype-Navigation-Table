...
class TableVC: UITableViewController {
    ...
    let items: [Items] =
        [
          Items(name: "Item Zero", description: "Description of Zero"),
          Items(name: "Item One", description: " Description of One"),
          Items(name: "Item Two", description: "Description of Two"),
          Items(name: "Item Three", description: "Description of Three")
        ]
