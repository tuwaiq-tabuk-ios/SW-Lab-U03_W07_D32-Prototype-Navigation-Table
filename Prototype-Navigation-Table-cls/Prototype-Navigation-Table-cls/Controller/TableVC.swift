...
//
//  Created by macbook air on 10/04/1443 AH.
//
...
class TableVC: UITableViewController {
  ...
  let items: [Item] = [Item(name: "Item 0", description: "Description 0"),
  ...
  override func tableView(
    ...
    let cell = tableView.dequeueReusableCell(withIdentifier: "reusableـcell", for: indexPath)
