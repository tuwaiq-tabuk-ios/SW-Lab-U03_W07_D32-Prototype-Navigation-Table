...
class TableVC: UITableViewController {
  ...
  let items: [Item] = [
    Item(name: "my breakfast", description : "My favorite breakfast🥛🥛 ، 🥚🥚،🍳🍳،🍞🥖🍞 "),
    Item(name: "my lunch", description : " My favorite lunch 🍚🍚 ، 🥓🥓🥓"),
    Item(name: "my dinner ", description : "My favorite dinner 🥗🥗🥗 ،🍎🍏،🍌🍌 "),
  ...
  //
  //    currentdescription =
  //    items[indexPath.row].description
  //
  //    performSegue(withIdentifier: "show_detail", sender: nil)
  //
  //    }
  ...
  //
  //      if let destinationVC = segue.destination as? DetailVC {
  //        destinationVC.labeltemText = currentdescription
  //      }
  //    }
  //  override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
  //
  //    currentDescription = items[indexPath.row].description
  //
  //    performSegue(withIdentifier: "descriptionText", sender: nil)
  //
  //    }
